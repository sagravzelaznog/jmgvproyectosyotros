...
function loadQuestion() {
    ...
    currentQ.options.forEach((opt, index) => {
        ...
        btn.innerHTML = opt; // Cambiado a innerHTML para soportar el HTML que genere renderMathInElement si algo se mezcla, aunque textContent + renderMathInElement debería bastar. Mejor dejamos innerHTML por si acaso hay <b> o <i>. No, las opciones en questions.js son strings puros. Pero pongamos innerHTML para evitar escapar HTML si lo hay.
    ...
    if (typeof renderMathInElement === 'function') {
        renderMathInElement(quizActive, {
            delimiters: [
