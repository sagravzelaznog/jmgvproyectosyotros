...
async function seedInkscape() {
  console.log('--- INICIANDO SEED DE INKSCAPE ---');

  const dataPath = path.join(__dirname, '..', '..', '..', 'scratch', 'inkscape_firebase_data.json');
  ...
  console.log('\\n--- SEED DE INKSCAPE COMPLETADO EXITOSAMENTE ---');
  process.exit(0);
}

seedInkscape().catch(console.error);
