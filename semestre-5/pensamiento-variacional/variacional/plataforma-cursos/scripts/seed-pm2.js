...
async function seedPM2() {
  console.log('--- INICIANDO SEED DE PM2 (PENSAMIENTO MATEMÁTICO 2) ---');

  const dataPath = path.join(__dirname, '..', '..', '..', 'scratch', 'pm2_firebase_data.json');
  ...
  console.log('\\n--- SEED DE PM2 COMPLETADO EXITOSAMENTE ---');
  process.exit(0);
}

seedPM2().catch(console.error);
