    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {([
          ...
          { id: "fisica", title: "Análisis Físicos (Física)", adminOnly: false, description: "Curso de estática, dinámica, cinemática y termodinámica orientado al diseño y construcción de una prótesis mecánica o grúa hidráulica." },
